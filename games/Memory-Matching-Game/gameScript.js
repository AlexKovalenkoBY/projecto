...
window.onload = function() {
    $("#ol").html(`<center><div id="inst"><h3> Добро пожаловать!</h3>Правила игры:<br/><br/><li>Найти пару для предметов, переворачивая их</li><li>Чтобы перевернуть карточку, нажмите на нее.</li><li>Если карточки не будут похожи, они будут развернуты назад.</li><p style="font-size:18px;">Выберите поле для игры.</p></div><button onclick="start(3, 4)">3 x 4</button> <button onclick="start(4, 4)" style="w">4 x 4</button><button onclick="start(4, 5)">4 x 5</button><button onclick="start(5, 6)">5 x 6</button><button onclick="start(6, 6)">6 x 6</button></center>`);
}
